...
environ["DB_URL"] = "sqlite:///tests/karp_test.db"
...
from karp.database import engine  # noqa: E402
...
from karp.models import ResourceDefinition  # noqa: E402
from karp.domain.services import indexing
...
#             ResourceDefinition.__table__.create(bind=engine)
#             yield app
...
def client():
    ...
    alembic_main(["--raiseerr", "downgrade", "head"])
