...
def test_es_search(es, client_with_data_f):
    ...
    with client_with_data.application.app_context():
        ...
        query = context.ctx.search.build_query(args, "places,municipalities")
        ids = context.ctx.search.search_with_query(query)
...
def test_es_search2(es, client_with_data_f):
    ...
    with client_with_data.application.app_context():
        ...
        result = context.ctx.search.search_with_query(query)
